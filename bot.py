import json, requests, os, shlex, asyncio, uuid, shutil 
 ...
 L6L6P = Client('TikTok', api_id=APP_ID, api_hash=API_HASH, bot_token=BOT_TOKEN) 
 ...
 @L6L6P.on_message(filters.command('start') & filters.private) 
 ...
 @L6L6P.on_message(filters.regex(pattern='.*http.*') & filters.private) 
